...
// Generated on Sat, 10 Dec 2022 06:51:52 GMT
...
class AppThemeGallery extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return ListView(
            children: [
                const _TextStyleSection(),const _DoubleSection(),const _ColorSection(),const _SizeSection(),const _GradientSection(),const _EdgeInsetsSection(),
            ...
            children: [
                _Header('Double'),
                 ...
                 _Token(
                    ...
                    child: _Double(theme.double.bodyExtraBoldCondensedItalicLetterSpacing),
                ),
                 _Token(
                 ...
                 _Token(
                    ...
                    child: _Double(theme.double.bodyExtraBoldCondensedItalicParagraphIndent),
                ),
                 _Token(
                    name: 'bodyExtraBoldCondensedItalicParagraphSpacing',
                    child: _Double(theme.double.bodyExtraBoldCondensedItalicParagraphSpacing),
                ),
                 _Token(
                    name: 'bodyH3FontSize',
        ...
        return Column(
            ...
            children: [
                _Header('Color'),
                 _Token(
                    name: 'colorsEmpty',
                    child: _Color(theme.color.colorsEmpty),
                ),
                 _Token(
                 ...
                 _Token(
                    name: 'colorsSemiRed',
                    child: _Color(theme.color.colorsSemiRed),
                ),
                 _Token(
